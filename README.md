...
```js
{
  "githubUser": "fernanfpinformatica",
...
2. Fetch the script locally:
  ...
  * With curl:
        ...
        && curl -fsSL https://raw.githubusercontent.com/fernanfpinformatica/dotfilesync/master/src/dfsync.sh \
          >| ${HOME}/.dotfilesync/dfsync.sh

  * With wget:

        mkdir -p ${HOME}/.dotfilesync \
        && wget -nv -O - https://raw.githubusercontent.com/fernanfpinformatica/dotfilesync/master/src/dfsync.sh \
          >| ${HOME}/.dotfilesync/dfsync.sh
